...
<body>
<!-- formulario -->
<form action="CreaCompra.php" method="POST">
<fieldset>
    <legend>Nuevo Productos BD</legend>
  ...
  <div class="form-group row">
    ...
    <input type="number" step="any" class="form-control-file" name="Preu" id="Preu" placeholder="Preu">
  </div>
  </br>
  <button type="submit" value="Nuevo" class="btn btn-success" href="indexDB.php" >Nuevo Producto</button>
  </fieldset>
</form>
</br>
<!--
